...
def get_user_info(api_key, api_secret, cookies, session_key=None):
	user_info_params = {
					...
					'fields': 'first_name,last_name,pic_small,name,website,username',
					'format': 'json',
	}

	if session_key:
		user_info_params['session_key'] = session_key
